...
read -p "Elige una opcion: " opc1
	case $opc1 in
			...
			3 )	echo
				...
				sleep 2
				sudo gnome-terminal -- sleep 1 && open https://www.google.com/search?q=%22+$codigo$telefono%22
				;;
			4 )	echo
				...
				echo "Abriendo Navegador...."
				sleep 3
				sudo gnome-terminal -- sleep 1 && open https://www.revealname.com/
				;;
			5 )	echo
				read -p "[*] Escribe el Codigo del pais del Telefono del Objetivo (Ej: 34): " codigo
				read -p "[*] Escribe el Numero de Telefono del Objetivo (Ej: 62529541): " telefono
